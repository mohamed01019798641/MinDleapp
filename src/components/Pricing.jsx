    ...
    <div className=" bg-[#f7f8fc] pt-32 " id="pricing">
      <div className=" container mx-auto  px-8">
        <div className="text-center mp-12">
          <h2 className="text-4xl font-bold font-secondary mb-3">Perfect For Small $ Largne Brands </h2>
          <p className="text-lg mb-12 md:w-2/3 mx-auto">Lorem, ipsum dolor sit amet consectetur adipisicing elit.

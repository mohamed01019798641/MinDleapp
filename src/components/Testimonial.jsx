...
function Testimonial() {
  return (
    <div id='testimonial' className='bg-[#f7f8fc] py-12'>
      ...
      <div className="text-center mp-12">
          <h2 className="text-4xl font-bold font-secondary mb-3">What Our Clients Say </h2>
          <p className="text-lg mb-12 md:w-1/2 mx-auto"> amet consectetur adipisicing elit.
             Aut, distinctio. Dicta corrupti laborum nam eos ducimus quibusdam 
              Sunt perferendis ducimus architecto. 
           
            </p>
        </div>

        <div className=" flex flex-col md:w-4/5  m-auto md:flex-row md:gap-12 gap-8 ">
          {
              ...
              <div key={index} className=" relative bg-white rounded-lg p-6 flex-1">
                ...
                <div className="flex flex-col space-y-3 mb-4 ">
                  ...
                  <div className=" flex gap-1">
                    <img src={testimonial.image} alt="reviewer" className=" size-16 rounded-full object-cover mr-4"/>
                    <div>
